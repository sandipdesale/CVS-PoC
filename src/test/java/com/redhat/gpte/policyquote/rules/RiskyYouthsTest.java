...
public class RiskyYouthsTest extends BaseRulesTest {
    
    @Test
    public void testRiskyYouths() throws Exception {
        
        KieServices ks = KieServices.Factory.get();
        KieFileSystem kfs = ks.newKieFileSystem();
        KieRepository kr = ks.getRepository();
        
        Resource resource = new ClassPathResource("RiskyYouths.drl");
        
        kfs.write("src/main/resources/RiskyYouths.drl", resource);
        ...
        Assert.assertEquals(700, policy.getPrice().intValue());
        ...
        Assert.assertThat( values.get(0).getMatch().getRule().getName(),IsEqual.equalTo("RiskyYouths"));
