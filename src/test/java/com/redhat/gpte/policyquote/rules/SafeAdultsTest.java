...
public class SafeAdultsTest extends BaseRulesTest {
    
    @Test
    public void testSafeAdults() throws Exception {
        
        KieServices ks = KieServices.Factory.get();
        KieFileSystem kfs = ks.newKieFileSystem();
        KieRepository kr = ks.getRepository();
        
        Resource resource = new ClassPathResource("SafeAdults.drl");
        
        kfs.write("src/main/resources/SafeAdults.drl", resource);
        ...
        Assert.assertEquals(120, policy.getPrice().intValue());
        ...
        Assert.assertThat( values.get(0).getMatch().getRule().getName(),IsEqual.equalTo("SafeAdults"));
